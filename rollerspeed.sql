...
--
-- Host: 127.0.0.1    Database: rollerspeed
-- ------------------------------------------------------
...
CREATE TABLE `alumnos` (
  ...
  CONSTRAINT `alumnos_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
...
INSERT INTO `clases` VALUES (1,'Clase Principiantes','10:00:00','Principiante',NULL);
...
CREATE TABLE `instructores` (
  ...
  PRIMARY KEY (`id`),
  KEY `usuario_id` (`usuario_id`),
  CONSTRAINT `instructores_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `roles` VALUES (1,'ADMIN'),(3,'ALUMNO'),(2,'INSTRUCTOR'),(4,'PUBLICO');
...
INSERT INTO `users` VALUES (1,'admin','$2a$12$EYNO0c0uI8WgC6o/L/Q3FudPeo9JFTH6hwlxegvfgyF4JUYFRnOYu',1);
...
-- Dump completed on 2025-03-29 18:14:13
